...
Duterte also shifted foreign relations toward China and Russia while criticizing the United States. In November 2016, the Supreme Court approved the burial of Ferdinand Marcos at the Libingan ng mga Bayani, which sparked protests.
<br><br>
...
<div id="noteForm" class="note-form">
    <form action="" method="post">
        ...
        <input type="text" name="note_title" id="" placeholder="Title">
