...
<body>
 ...
 <div id="sidebar" class="sidebar">
    ...
    <a href="../HOME1/home.phpl"><i class="fas fa-home"></i> Home</a>
    <a href="../BOOKMARK/bookmark1.phpl"><i class="fas fa-bookmark"></i> Bookmark</a>
    <a href="../GAMES/games.phpl"><i class="fas fa-gamepad"></i> Games</a>
    <a href="../NOTES/notes-box.phpl"><i class="fas fa-sticky-note"></i> Notes</a>
    <a href="../GALLERY/gallery.phpl"><i class="fas fa-image"></i> Gallery</a>
    <a href="../QUIZ1/quiz1.phpl"><i class="fas fa-question-circle"></i> Quiz</a>
    <a href="../TRIVIA & FACTS/trivfac.phpl"><i class="fas fa-lightbulb"></i> Trivias & Facts</a>
    <a href="../LANDING PAGE/landpage.phpl"><i class="fas fa-sign-out-alt"></i> Logout</a>
</div>
